...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.velocity_verticalLayout = QtWidgets.QVBoxLayout()
        self.velocity_verticalLayout.setObjectName("velocity_verticalLayout")
        self.velocity_label = QtWidgets.QLabel(self.centralwidget)
        self.velocity_label.setMinimumSize(QtCore.QSize(0, 0))
        self.velocity_label.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.velocity_label.setAlignment(QtCore.Qt.AlignCenter)
        self.velocity_label.setObjectName("velocity_label")
        self.velocity_verticalLayout.addWidget(self.velocity_label)
        ...
        self.velocity_display = QtWidgets.QLabel(self.centralwidget)
        self.velocity_display.setMinimumSize(QtCore.QSize(140, 70))
        self.velocity_display.setMaximumSize(QtCore.QSize(140, 70))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.velocity_display.setFont(font)
        self.velocity_display.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.velocity_display.setObjectName("velocity_display")
        self.velocity_horizontalLayout.addWidget(self.velocity_display)
        self.velocity_verticalLayout.addLayout(self.velocity_horizontalLayout)
        self.gridLayout_2.addLayout(self.velocity_verticalLayout, 4, 0, 1, 1)
        ...
        self.power_display = QtWidgets.QLabel(self.centralwidget)
        self.power_display.setMinimumSize(QtCore.QSize(140, 70))
        self.power_display.setMaximumSize(QtCore.QSize(140, 70))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.angle_reset_pushButton.setMinimumSize(QtCore.QSize(180, 0))
        self.angle_reset_pushButton.setMaximumSize(QtCore.QSize(180, 16777215))
        self.angle_reset_pushButton.setObjectName("angle_reset_pushButton")
        self.instructions_gridLayout.addWidget(self.angle_reset_pushButton, 0, 0, 1, 1)
        ...
        self.torque_display = QtWidgets.QLabel(self.centralwidget)
        self.torque_display.setMinimumSize(QtCore.QSize(140, 70))
        self.torque_display.setMaximumSize(QtCore.QSize(140, 70))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.turns_label.setMaximumSize(QtCore.QSize(300, 25))
        ...
        self.angle_label.setMaximumSize(QtCore.QSize(300, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.velocity_display.setText(_translate("MainWindow", "TextLabel"))
        self.power_label.setText(_translate("MainWindow", "Power"))
        self.power_display.setText(_translate("MainWindow", "TextLabel"))
        self.emergency_pushButton.setText(_translate("MainWindow", "EMERGENCY STOP"))
        self.angle_reset_pushButton.setText(_translate("MainWindow", "Calibrate angle (0°)"))
        ...
        self.comments_save_pushButton.setText(_translate("MainWindow", "Save comment"))
        ...
        self.torque_display.setText(_translate("MainWindow", "TextLabel"))
